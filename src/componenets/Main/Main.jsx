  ...
  return (
    <div className="main">
      <div className="main__heading">
        <h2 className="main__heading__title">
        ...
        <li className="main__list__item">
          ...
          <div>
            ...
            <p className="main__list__item__text">
              ...
              niches. Filter by audience demographics, engagement rates, and
              more to find the perfect match for your brand.
            </p>
          </div>
        </li>
        <li className="main__list__item">
          ...
          <div>
            ...
            <p className="main__list__item__text">
              ...
              negotiation needed –just choose the influencers that align with
              your brand and budget.
            </p>
          </div>
        </li>
        <li className="main__list__item">
          ...
          <div>
            ...
            <p className="main__list__item__text">
              ...
              their engaged audience. Track performance metrics, measure ROI,
              and refine your strategy for even greater impact.
            </p>
          </div>
        </li>
      </ul>
      ...
      <div className="second__main">
        <div className="second__main__col__one">
          <h1 className="second__main__col__one__title">
            Ready to Elevate Your Brand?
          </h1>
          <p className="second__main__col__one__subtitle">
            Sign up today and start connecting with influencers to amplify your
            online presence.
          </p>
          <button className="second__main__col__one__button">
            Sign Up Now
          </button>
        </div>
        ...
        <div className="second__main__col__two">
          <img
            className="second__main__col__two__image"
            src={headerimg}
            alt="influencer"
          />
        </div>
